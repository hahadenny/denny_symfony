...
class MainController extends AuthController
{
		...
		$constraints = new Assert\Collection([
			...
			'MinYear' => [new Assert\Optional([ new Assert\Length(['min' => 4, 'max' => 4]), new Assert\NotBlank ])],
			'MaxYear' => [new Assert\Optional([ new Assert\Length(['min' => 4, 'max' => 4]), new Assert\NotBlank ])],
			'MinMsrp' => [new Assert\Optional([ new Assert\Regex(['pattern' => '/^\d*\.?\d*$/']), new Assert\NotBlank ])],
			'MaxMsrp' => [new Assert\Optional([ new Assert\Regex(['pattern' => '/^\d*\.?\d*$/']), new Assert\NotBlank ])],
			'MinMiles' => [new Assert\Optional([ new Assert\Regex(['pattern' => '/^[0-9]+$/']), new Assert\NotBlank ])],
			'MaxMiles' => [new Assert\Optional([ new Assert\Regex(['pattern' => '/^[0-9]+$/']), new Assert\NotBlank ])],
